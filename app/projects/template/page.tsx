  ...
  const sketches = [
    {
      ...
      description: 'Early concept sketches exploring different approaches to the design challenge.'
    },
    {
      src: '/placeholder-image-2.webp', 
      title: 'Detailed Wireframes',
      description: 'Detailed wireframes examining interface components and user flow interactions.'
    },
    {
      src: '/placeholder-image-3.webp',
      title: 'Extended View',
      description: 'Comprehensive layout explorations showing the full interface with expanded functionality.'
    }
  ]
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="pt-28 pb-16 px-6">
          <div className="max-w-[90rem] mx-auto">
            <Reveal>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900">Project Name — Case Study</h1>
            </Reveal>
            <Reveal delay={120}>
              <p className="mt-4 text-xl text-gray-600 max-w-3xl pb-6">Project description and value proposition. Replace this with your project's main narrative and key outcomes.</p>
            </Reveal>
            <Reveal delay={180}>
              <div className="mb-6">
            ...
            <Reveal delay={220}>
              <div className="flex justify-center items-center w-full">
                <div className="w-[1483px] h-[900px] bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-lg">
                    <iframe 
                      src="https://your-figma-prototype-url.figma.site/"
                      width="1483" 
                      height="800" 
                      className="w-full h-full border-0"
                      style={{ objectFit: 'contain' }}
                      title="Project Case Study - Figma Site"
                      allowFullScreen
                    />
                </div>
              </div>
        ...
        <section className="px-6 py-16">
          <div className="max-w-[90rem] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              {[{ t: 'About Project', d: 'Brief description of the project or product.' }, { t: 'The Challenge', d: 'Key problem or challenge that needed to be solved.' }, { t: 'My Role', d: 'Your role and responsibilities in this project.' }].map((b, i) => (
            ...
            <Reveal>
              <div className="grid sm:grid-cols-3 gap-8 items-center">
                <div className="text-center">
                  ...
                  <div className="mt-2 text-gray-600">Metric 1</div>
                </div>
                <div className="text-center">
                  <div className="text-5xl font-bold text-gray-900">
                    +<CountUpOnView to={18} className="[tabular-nums]" />%
                  </div>
                  <div className="mt-2 text-gray-600">Metric 2</div>
                </div>
        ...
        <section className="px-6 py-16 bg-gray-50">
          <div className="max-w-[90rem] mx-auto">
            <SectionHeader eyebrow="User Flows" title="User interaction pathways" />
            <Reveal>
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                <div className="mb-6">
                  <Image src="/placeholder-flowchart.svg" alt="User Flow Diagram" width={800} height={400} className="w-full h-auto rounded-lg" />
                </div>
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Description of first step in user flow</p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Description of second step in user flow</p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Description of third step in user flow</p>
                  </div>
                </div>
              </div>
            </Reveal>
                    ...
                    <Reveal>
                      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                        ...
                        <div className="px-4 py-3 text-sm text-gray-600 border-t border-gray-100">
                          {i === 0 && "Outcome: description of first screen outcome"}
                          {i === 1 && "Outcome: description of second screen outcome"}
                          {i === 2 && "Outcome: description of third screen outcome"}
                        </div>
                      </div>
                    </Reveal>
                  </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <Reveal>
              <p className="text-gray-700 leading-relaxed">
                Key learning or insight from the project. Replace with your actual reflection.
              </p>
            </Reveal>
            <Reveal delay={120}>
              <p className="mt-4 text-gray-700 leading-relaxed">
                Additional insights or takeaways from working on this project.
              </p>
            </Reveal>
            <Reveal delay={220}>
              <div className="mt-8 text-right font-semibold text-gray-900">— Your Name</div>
            </Reveal>
          </div>
        </section>
        ...
        <div className="pb-12"> 
          <NextProjectButton
            nextProjectPath="/projects/next-project"
            nextProjectTitle="Next Project Name"
            nextProjectDescription="Brief description of the next project in your portfolio."
            className="bg-white"
          />
        </div>
      </main>
